...
import { defaultStyle, transitionStyles, duration } from './Instructions_styles';
    ...
    { (state) => (
      <aside className={defaultStyle} style={{...transitionStyles[state]}}>
        ...
        <p>
          ...
          interacts with the Game of Life by manipulating blocks and observing how
          it evolves, or, for advanced "players", by creating patterns with
          particular properties.
        </p>
        <p>
          Each block on the grid is in one of two possible states, alive or dead,
          or "populated" or "unpopulated". Each generation, every cell interacts
